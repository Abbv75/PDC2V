...
interface FicheDynamiqueConfigProps {
    open: boolean;
    onClose: () => void;
    title: string;
    icon: string;
...
export default ({
    ...
    const [bgColor, setBgColor] = useState(markerTextFont?.bgColor || green[600]);
        ...
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
            ...
            <DialogContent dividers>
                <Stack spacing={3}>
                    ...
                    {/* Field Selection - Same table as ElementConfig */}
                    <Box>
                        <FormGroup>
                            <FormControlLabel
                                control={
